...
module.exports = async function signin(request, response, next) {
...
module.exports = async function signup(request, response, next) {
...
module.exports = async function signout(request, response, next) {
    try {
